...
final class ShopDetailsViewModel: ObservableObject {
    ...
    init(shop: Shop) {
        ...
        self.mapRegion = MKCoordinateRegion(
            center: CLLocationCoordinate2D(latitude: shop.lat ?? 56.3111, longitude: shop.long ?? 69.2797),
            span: MKCoordinateSpan(latitudeDelta: 0.01, longitudeDelta: 0.01)
        )
        self.nearbyShops = Shop.mocks
    }
}
// MARK: - UI
...
#Preview {
    ShopDetailsView(viewModel: ShopDetailsViewModel(shop: Shop.mock))
}
